...
<div id="contact" class="section wb">
    <div class="container">
        <div class="section-title text-center">
            <h3>Get in touch</h3>
            <p class="lead">Let us give you more details about the special offers. Please fill out the form below. <br>happy to work with us!</p>
        </div><!-- end title -->
                        ...
                        <fieldset class="row-fluid">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <select name="select_service" id="select_service" class="selectpicker form-control" data-style="btn-white">
                                    ...
                                    <option value="Web Design">All In One Printer</option>
                                    <option value="Web Development">Scanner</option>
                                    <option value="Graphic Design">Business Printer</option>
        ...
        <div class="row">
            <div class="col-md-offset-1 col-sm-10 col-md-10 col-sm-offset-1 pd-add">
                <div class="address-item">
                    ...
                    <!--</div>-->
                    <!--<h3>Headquarters</h3>-->
                    <!--<p>Office No. 1, Chaudhary Villa-->
                        <!--<br>Salunke Vihar Road, Kondhwa Kh. Pune-48</p>-->
                </div>
                <div class="address-item">
                    <div class="address-icon">
                    ...
                    <h3>Email Us</h3>
                    <p>connect@instantprinthelp.com
                        <br>support@instantprinthelp.com</p>
                </div>
                <div class="address-item">
                    <div class="address-icon">
